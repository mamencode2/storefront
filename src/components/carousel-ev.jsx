 ...
 * @see https://v0.dev/t/rtJK2BKeg7E
 */
      ...
      <div className="px-4 py-2">
        <div className="flex items-baseline justify-between">
          <div className="flex items-baseline">
            <span className="text-lg font-bold text-black">$11.40</span>
            <span className="ml-2 text-sm line-through text-gray-500">$13.30</span>
        ...
        <div className="mt-1">
          <h1 className="text-lg font-bold text-black">
            SHEIN Kids SUNSHNE Tween Girl's Yellow Spaghetti Strap Tank Top And Floral Printed Denim Shorts
          </h1>
        </div>
        <div className="mt-4">
          <Select>
